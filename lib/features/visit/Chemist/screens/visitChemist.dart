                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    setState(() {
                      ...
                      StockistVisitController.createDoctorVisit(
                        ...
                        _visitListController.fetchVisitList().then((_) {
                          setState(() {
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Expanded(
            child: FutureBuilder(
              future: _visitListController.fetchVisitList(),
              builder: (context, AsyncSnapshot<void> snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return const Center(child: Text(TTexts.noRecentCallAvailable));
                } else {
                  List<ChemistVisitModel> filteredDoctors = _visitListController
                      .salesList
                      .where((doctor) =>
                  doctor.chemist?.firmName?.toLowerCase().contains(_searchQuery.toLowerCase()) ?? false)
                      .toList();
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          title: Text(
                            doctorVisit.chemist?.firmName ?? "Unknown Doctor",
                            style: const TextStyle(fontWeight: FontWeight.bold),
                          ),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("Sales Rep: ${doctorVisit.chemist?.firmName ?? ""}"),
                              Text(
